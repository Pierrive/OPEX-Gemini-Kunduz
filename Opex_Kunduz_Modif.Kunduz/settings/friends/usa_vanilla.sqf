...
if (isClass(configFile >> "cfgPatches" >> "acre_main")) then {OPEX_friendly_radiosShortDistance = ["ACRE_PRC152"]} else {OPEX_friendly_radiosShortDistance = ["ItemRadio"]};
if (isClass(configFile >> "cfgPatches" >> "acre_main")) then {OPEX_friendly_radiosLongDistance = ["ACRE_PRC117F"]} else {OPEX_friendly_radiosLongDistance = ["B_Carryall_mcamo"]};
